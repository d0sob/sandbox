...
PlayerMovement.attributes.add("camera", { type: "entity" }),
  PlayerMovement.attributes.add("power", { type: "number", default: 10 }),
  PlayerMovement.attributes.add("lookSpeed", { type: "number", default: 0.25 }),
  PlayerMovement.attributes.add("bulletSpeed", { type: "number", default: 10 });
var camcam = null,
  cameraHeightChange = -0.3,
  hasMovedCamera = !1,
  originalPosition = null;
(PlayerMovement.prototype.initialize = function () {
  (this.bullet = this.app.root.findByName("bullet")),
    (this.roomEntity = this.app.root.findByName("Room")),
    (this.roomCollisionBox = this.app.root.findByName("roomlol")),
    (this.isInRoom = !1),
    (this.playerEntity = this.entity),
    (this.targetEntity = this.app.root.findByName("Roof")),
    (this.targetEntity.rigidbody.enabled = !1),
    this.targetEntity.collision.on(
      "collisionstart",
      this.onCollisionStart,
      this
    ),
    (this.hasEnteredTarget = !1),
    (this.camcam = this.app.root.findByName("Camera")),
    this.camcam ||
      console.error(
        "Camera entity not found. Make sure to provide the correct name or tag."
      ),
    (originalPosition = this.camcam.getLocalPosition().clone()),
    this.app.mouse.on(pc.EVENT_MOUSEDOWN, this.onMouseDown, this),
    (this.force = new pc.Vec3()),
    (this.eulers = new pc.Vec3());
  var t = this.app;
  t.mouse.on("mousemove", this._onMouseMove, this),
    t.mouse.on(
      "mousedown",
      function () {
        t.mouse.enablePointerLock();
      },
      this
    ),
  ...
  (PlayerMovement.prototype.update = function (t) {
    this.playerEntity.getPosition().y >= 6.2
      ? ((this.targetEntity.rigidbody.enabled = !0),
        this.app.keyboard.wasPressed(pc.KEY_T) &&
          (this.entity.rigidbody.teleport(0, -6, 0),
          (this.app.root.findByName("Room").enabled = !1)),
        (this.targetEntity.rigidbody.type = pc.BODYTYPE_STATIC))
      : ((this.targetEntity.rigidbody.enabled = !1),
        this.roomEntity.findByTag("Renderable").forEach(function (t) {
          t.enabled = !0;
        })),
      this.camera || this._createCamera();
    var e = this.force,
      i = this.app,
      o = this.camera.forward,
      s = this.camera.right,
      a = 0,
      r = 0;
    i.keyboard.isPressed(pc.KEY_A) && ((a -= s.x), (r -= s.z)),
      i.keyboard.isPressed(pc.KEY_D) && ((a += s.x), (r += s.z)),
      i.keyboard.isPressed(pc.KEY_W) && ((a += o.x), (r += o.z)),
      i.keyboard.isPressed(pc.KEY_S) && ((a -= o.x), (r -= o.z)),
      i.keyboard.isPressed(pc.KEY_SHIFT)
        ? (this.speed = 400 + this.power)
        : (this.speed = this.power),
      i.keyboard.isPressed(pc.KEY_E) &&
        this.entity.rigidbody.applyImpulse(0, 3, 0),
      i.keyboard.isPressed(pc.KEY_Q) &&
        this.entity.rigidbody.applyImpulse(0, -3, 0),
      this.app.keyboard.isPressed(pc.KEY_C)
        ? ((this.speed = this.power - 150),
          hasMovedCamera ||
            ((this.camcam.getLocalPosition().y += cameraHeightChange),
            (hasMovedCamera = !0)))
        : (this.camcam.setLocalPosition(originalPosition),
          (hasMovedCamera = !1)),
      (0 === a && 0 === r) ||
        (e.set(a, 0, r).normalize().scale(this.speed),
        this.entity.rigidbody.applyForce(e)),
      this.camera.setLocalEulerAngles(this.eulers.y, this.eulers.x, 0);
    const n = this.entity.findByName("Feet").getPosition(),
      d = pc.Vec3.DOWN.clone(),
      h = new pc.Vec3().copy(n).add(d.scale(100)),
      y = this.app.systems.rigidbody.raycastFirst(n, h);
    (this.distance = y ? y.point.distance(n) : 1),
      this.distance > 0.5
        ? (this.entity.rigidbody.applyForce(0, -100, 0), (this.isLanded = !1))
        : (this.isLanded = !0),
      ...
      n.y < -10 &&
        ...
        (this.app.root.findByName("Room").enabled = !0));
  }),
  (PlayerMovement.prototype._onMouseMove = function (t) {
    (pc.Mouse.isPointerLocked() || t.buttons[0]) &&
      ((this.eulers.x -= this.lookSpeed * t.dx),
      (this.eulers.y -= this.lookSpeed * t.dy)),
  ...
  (PlayerMovement.prototype.onCollisionStart = function (t) {
    if (t.other === this.playerEntity) {
      var e = this.playerEntity.getPosition(),
        i = this.targetEntity.getPosition();
      e.y < i.y &&
        !this.hasEnteredTarget &&
        ((t.contacts.length = 0), (this.hasEnteredTarget = !0));
    }
  }),
  (PlayerMovement.prototype.onMouseDown = function (t) {
    if (0 === t.button) {
      var e;
      (e = this.bullet.clone()).setPosition(this.entity.getPosition()),
        e.setRotation(this.entity.getRotation()),
      ...
      var i = this.entity.getRotation(),
        o = -Math.sin(i.y),
        s = -Math.cos(i.y),
        a = new pc.Vec3(o, 0, s).clone().scale(10);
      e.rigidbody && e.rigidbody.applyImpulse(a);
    }
  });
...
class Polygon {
  constructor() {
    (this.points = []), (this.children = []), (this.area = 0);
  }
  moveTo(t, e) {
    this.points.push(new pc.Vec2(t, e));
  }
  lineTo(t, e) {
    this.points.push(new pc.Vec2(t, e));
  }
  close() {
    ...
    this.points.forEach((e) => {
      (this.area += 0.5 * t.cross(e)), (t = e);
    });
  }
  conicTo(t, e, s, i, a = 10) {
    p.set(t, e), p1.set(s, i);
    const n = this.points[this.points.length - 1],
      r = n.distance(p1) + p1.distance(p),
      h = Math.max(2, Math.min(a, r / 3));
    for (let t = 1; t <= h; t++) {
      const e = t / h;
      vTemp1.lerp(n, p1, e),
        vTemp2.lerp(p1, p, e),
        vTemp3.lerp(vTemp1, vTemp2, e),
        this.points.push(vTemp3.clone());
    }
  }
  cubicTo(t, e, s, i, a, n, r = 10) {
    p.set(t, e), p1.set(s, i), p2.set(a, n);
    const h = this.points[this.points.length - 1],
      c = h.distance(p1) + p1.distance(p2) + p2.distance(p),
      o = Math.max(2, Math.min(r, c / 3));
    for (let t = 1; t <= o; t++) {
      const e = t / o;
      vTemp1.lerp(h, p1, e),
        vTemp2.lerp(p1, p2, e),
        vTemp3.lerp(p2, p, e),
        vTemp4.lerp(vTemp1, vTemp2, e),
        vTemp5.lerp(vTemp2, vTemp3, e),
        vTemp6.lerp(vTemp4, vTemp5, e),
  ...
  inside(t) {
    ...
    return (
      this.points.forEach((i) => {
        ...
        a.y < t.y + EPSILON &&
          n.y > t.y + EPSILON &&
          (n.x - a.x) * (t.y - a.y) > (t.x - a.x) * (n.y - a.y) &&
          (e += 1),
          (s = i);
      }),
      e % 2 != 0
...
TextMesh.attributes.add("font", {
  ...
  (TextMesh.prototype.initialize = function () {
    (this.characters = []),
      ...
      this.font &&
        ...
        this.createText()),
      this.on("attr", function (t, e, s) {
        e !== s &&
          ("font" === t &&
            (this.font
              ? (this.fontData = opentype.parse(this.font.resource))
              : ((this.fontData = null), this.destroyCharacters())),
          this.fontData && this.createText());
      });
  }),
  (TextMesh.prototype.parseCommands = function (t) {
    var e = [];
    t.forEach(({ type: t, x: s, y: i, x1: a, y1: n, x2: r, y2: h }) => {
      switch (t) {
        case "M":
          e.push(new Polygon()), e[e.length - 1].moveTo(s, i);
          break;
        case "L":
          e[e.length - 1].moveTo(s, i);
          break;
        case "C":
          e[e.length - 1].cubicTo(s, i, a, n, r, h, this.maxCurveSteps);
          break;
        case "Q":
          e[e.length - 1].conicTo(s, i, a, n, this.maxCurveSteps);
          break;
        case "Z":
          e[e.length - 1].close();
      }
    }),
      e.sort((t, e) => Math.abs(e.area) - Math.abs(t.area));
    const s = [];
    for (let t = 0; t < e.length; ++t) {
      let i = null;
      for (let s = t - 1; s >= 0; --s)
        if (e[s].inside(e[t].points[0]) && e[t].area * e[s].area < 0) {
          i = e[s];
          break;
        }
      i ? i.children.push(e[t]) : s.push(e[t]);
    }
    const i = e.reduce((t, e) => t + e.points.length, 0),
      a = new Float32Array(2 * i);
    let n = 0;
    const r = [];
    s.forEach(function process(t) {
      const e = [],
        s = [];
      t.points.forEach(({ x: t, y: s }) => e.push(t, s)),
        ...
        a.set(e, 2 * n),
        earcut(e, s).forEach((t) => r.push(t + n)),
        (n += e.length / 2);
    });
    const h = this.characterSize / this.fontData.unitsPerEm,
      c = [];
    for (let t = 0; t < a.length; t += 2)
      c.push(a[t] * h, a[t + 1] * h, this.depth);
    for (let t = 0; t < a.length; t += 2) c.push(a[t] * h, a[t + 1] * h, 0);
    const o = r.length;
    for (let t = 0; t < o; t += 3) r.push(r[t + 2] + n, r[t + 1] + n, r[t] + n);
    e.forEach((t) => {
      for (let e = 0; e < t.points.length - 1; e++) {
        ...
        c.push(
          ...
          r.push(s, s + 1, s + 2, s + 1, s + 3, s + 2);
      }
    });
    const l = pc.calculateNormals(c, r);
    return { vertices: c, normals: l, indices: r };
  }),
  (TextMesh.prototype.calculateWidth = function () {
    const t = this.fontData,
      e = this.characterSize / t.unitsPerEm;
    let s = 0;
    for (var i = 0; i < this.text.length; i++) {
      const r = this.text.charAt(i);
      if (
        ((s += t.charToGlyph(r).advanceWidth * e), i < this.text.length - 1)
      ) {
        s += this.characterSpacing;
        var a = t.charToGlyph(r),
          n = t.charToGlyph(this.text.charAt(i + 1));
        s += t.getKerningValue(a, n) * this.kerning * e;
      }
    }
    return s;
  }),
  ...
  (TextMesh.prototype.createText = function () {
    ...
    for (
      ...
      var r = this.text.charAt(n),
        h = t.charToGlyph(r),
        c = this.parseCommands(h.path.commands);
      if (c.vertices.length > 0) {
        var o = this.app.graphicsDevice,
          l = new pc.Mesh(o);
        l.setPositions(c.vertices),
          l.setNormals(c.normals),
          l.setIndices(c.indices),
          l.update(pc.PRIMITIVE_TRIANGLES);
        var d = new pc.MeshInstance(l, a),
          u = new pc.Entity(r);
        u.addComponent("render", {
          meshInstances: [d],
          renderStyle: this.renderStyle,
        }),
          this.entity.addChild(u),
          u.setLocalPosition(i, 0, 0),
          this.characters.push(u);
      }
      if (n < this.text.length - 1) {
        var m = t.charToGlyph(this.text.charAt(n + 1));
        i += t.getKerningValue(h, m) * this.kerning * e;
      }
      i += h.advanceWidth * e + this.characterSpacing;
    }
  }); // opentype.min.js
!(function (e, t) {
  ...
  (R.prototype.isEmpty = function () {
    ...
    (G.prototype.curveTo = G.prototype.bezierCurveTo =
    ...
    (G.prototype.quadTo = G.prototype.quadraticCurveTo =
      function (e, t, r, n) {
        this.commands.push({ type: "Q", x1: e, y1: t, x: r, y: n });
      }),
    (G.prototype.close = G.prototype.closePath =
      function () {
    ...
    (G.prototype.toPathData = function (o) {
      function e() {
        for (
  ...
  var C = { fail: w, argument: L, assert: L },
    D = 2147483648,
    I = {},
    M = {},
    B = {};
  ...
  (M.BYTE = function (e) {
    return (
      C.argument(0 <= e && e <= 255, "Byte value should be between 0 and 255."),
      [e]
    );
  }),
    (B.BYTE = A(1)),
  ...
  function Z(e) {
    1 === e.format
      ...
      : C.assert(!1, "Can't create coverage table format 2 yet.");
  }
  function Q(e) {
    X.call(
      this,
      ...
      j("lookup", e, function (e) {
        ...
        return (
          ...
          new X(
            ...
            ].concat(j("subtable", e.subtables, t))
          )
        );
      })
    );
  ...
  (M.CHARSTRING = function (e) {
    ...
    (M.OBJECT = function (e) {
      var t = M[e.type];
      return (
        C.argument(void 0 !== t, "No encoding function for type " + e.type),
        t(e.value)
      );
    }),
    (B.OBJECT = function (e) {
      var t = B[e.type];
      return (
        C.argument(void 0 !== t, "No sizeOf function for type " + e.type),
        t(e.value)
      );
    }),
    (M.TABLE = function (e) {
      ...
      for (var p = 0; p < n.length; p += 1) {
        var c = a[p],
          h = t.length;
        C.argument(h < 65536, "Table " + e.tableName + " too big."),
          (t[c] = h >> 8),
          (t[c + 1] = 255 & h),
          (t = t.concat(n[p]));
      }
  ...
  (be.prototype.bindConstructorValues = function (e) {
    ...
    (be.prototype.getPath = function (e, t, r, n, a) {
      ...
      for (var p = new G(), c = 0; c < o.length; c += 1) {
        var h = o[c];
        "M" === h.type
  ...
  function Be(v, m, e) {
    ...
    if (v.isCIDFont) {
      ...
      (T = n._subrs),
        ...
        (t = n._defaultWidthX),
        (k = n._nominalWidthX);
    } else (T = v.tables.cff.topDict._subrs), (U = v.tables.cff.topDict._subrsBias), (t = v.tables.cff.topDict._defaultWidthX), (k = v.tables.cff.topDict._nominalWidthX);
    var I = t;
    function M(e, t) {
      L && O.closePath(), O.moveTo(e, t), (L = !0);
    }
    function B() {
      E.length % 2 == 0 || w || (I = E.shift() + k),
        (R += E.length >> 1),
        (E.length = 0),
        (w = !0);
    }
        ...
        for (var r, n, a, o, s, i, u, l, p, c, h, f, d = 0; d < t.length; ) {
          ...
          switch (((d += 1), g)) {
            ...
            case 3:
              ...
              break;
            case 4:
              1 < E.length && !w && ((I = E.shift() + k), (w = !0)),
                (D += E.pop()),
                M(C, D);
              break;
            case 5:
              for (; 0 < E.length; )
                (C += E.shift()), (D += E.shift()), O.lineTo(C, D);
              break;
            case 6:
              for (
                ;
                0 < E.length &&
                ((C += E.shift()), O.lineTo(C, D), 0 !== E.length);

              )
                (D += E.shift()), O.lineTo(C, D);
              break;
            case 7:
              for (
                ;
                0 < E.length &&
                ((D += E.shift()), O.lineTo(C, D), 0 !== E.length);

              )
                (C += E.shift()), O.lineTo(C, D);
              break;
            case 8:
              for (; 0 < E.length; )
                (y = C + E.shift()),
            ...
            case 25:
              ...
              break;
            case 26:
              for (E.length % 2 && (C += E.shift()); 0 < E.length; )
                (y = C),
                  (b = D + E.shift()),
                  (S = y + E.shift()),
                  (x = b + E.shift()),
  ...
  var He = {
    parse: function (r, n, a, e) {
      ...
      if (
        (0 === f.encoding
          ? (a.cffEncoding = new ge(pe, U))
          : 1 === f.encoding
          ? (a.cffEncoding = new ge(ce, U))
        ...
        a._push = function (e) {
          ...
          a.glyphs.push(e, Te.cffGlyphLoader(a, e, Be, t));
        };
      else
        for (var k = 0; k < a.nGlyphs; k += 1) {
          var O = y.objects[k];
          a.glyphs.push(k, Te.cffGlyphLoader(a, k, Be, O));
        }
    },
    make: function (e, t) {
      for (
  ...
  var qe = {
    ...
    parse: function (e, t) {
      var r = new ie.Parser(e, t),
        n = r.parseULong();
      C.argument(1 === n, "Unsupported ltag table version."),
        r.skip("uLong", 1);
  ...
  var ct = {
    parse: function (e, t) {
      var r = new oe(e, (t = t || 0)),
        n = r.parseVersion(1);
      return (
        C.argument(1 === n || 1.1 === n, "Unsupported GSUB table version."),
        1 === n
          ? {
              version: n,
  ...
  var ht = {
    parse: function (e, t) {
      var r = new ie.Parser(e, t),
        n = r.parseULong();
      C.argument(1 === n, "Unsupported META table version."),
        r.parseULong(),
        r.parseULong();
      for (var a = r.parseULong(), o = {}, s = 0; s < a; s++) {
        var i = r.parseTag(),
    ...
    for (var s = 0; s < e.length; s += 1) {
      ...
      for (
        n.push({ name: l.tag + " Table Record", type: "RECORD", value: l }),
          ...
          o += u,
          C.argument(!isNaN(o), "Something went wrong calculating the offset.");
        o % 4 != 0;
  ...
  var yt = {
    ...
    fontToTable: function (e) {
      ...
      var I = [],
        ...
        N = [S, x, T, U, M, O, G, A, k];
      B && N.push(B),
        e.tables.gsub && N.push(ct.make(e.tables.gsub)),
        F && N.push(F);
      for (
        var P = vt(N), H = dt(P.encode()), z = P.fields, W = !1, _ = 0;
        _ < z.length;
        _ += 1
      )
  ...
  function Ct(e, t, r) {
    ...
    if (
      ...
      if ((C.argument(n.length === l, "Bad flags."), 0 < s.length)) {
        var f,
          d = [];
        if (0 < l) {
          for (var g = 0; g < l; g += 1)
          ...
          for (var v = 0, m = 0; m < l; m += 1)
            (a = n[m]), ((f = d[m]).x = Lt(o, a, v, 2, 16)), (v = f.x);
          for (var y = 0, b = 0; b < l; b += 1)
            (a = n[b]), ((f = d[b]).y = Lt(o, a, y, 4, 32)), (y = f.y);
        }
        e.points = d;
      } else e.points = [];
  ...
  ((Ut.prototype = Tt.prototype =
    ...
    (Ut.prototype.getKerningValue = function (e, t, r) {
    ...
    (Ut.prototype.getKerningTables = function (e, t) {
      if (this.font.tables.gpos) return this.getLookupTables(e, t, "kern", 2);
    }),
    ((kt.prototype = Tt.prototype).createDefaultTable = function () {
      return {
        version: 1,
        scripts: [
          {
    ...
    (kt.prototype.getSingle = function (e, t, r) {
      for (
    ...
    (kt.prototype.getAlternates = function (e, t, r) {
      for (
    ...
    (kt.prototype.getLigatures = function (e, t, r) {
      for (
    ...
    (kt.prototype.addSingle = function (e, t, r, n) {
    ...
    (kt.prototype.addAlternate = function (e, t, r, n) {
    ...
    (kt.prototype.addLigature = function (e, t, r, n) {
    ...
    (kt.prototype.getFeature = function (e, t, r) {
    ...
    (kt.prototype.add = function (e, t, r, n) {
        ...
        return a.lowMemory
          ? ((o = e),
            ...
            (u._push = function (e) {
              var t = i[e];
              t !== i[e + 1]
                ? l.push(e, Te.ttfGlyphLoader(u, e, Ct, o, s + t, Mt))
          ...
          : (function (e, t, r, n) {
              for (
                ...
                var s = r[o];
                s !== r[o + 1]
                  ? a.push(o, Te.ttfGlyphLoader(n, o, Ct, e, t + s, Mt))
  ...
  function Qt(e, t) {
    ...
    return (
      (t /= r),
      1 === (e /= r) && 0 === t ? jt : 0 === e && 1 === t ? Yt : new Zt(e, t)
    );
  }
  function Kt(e, t, r, n) {
  ...
  Object.freeze(jt),
    ...
    (Zt.prototype.distance = function (e, t, r, n) {
      return (
        this.x * jt.distance(e, t, r, n) + this.y * Yt.distance(e, t, r, n)
      );
    }),
  ...
  function er(e, t) {
    switch (((this.env = e), (this.stack = []), (this.prog = t), e)) {
      ...
      case "prep":
        (this.fv = this.pv = this.dpv = jt), (this.round = zt);
    }
  }
  function tr(e) {
    for (
    ...
    (this.tokens = []),
      ...
      function (r) {
        ...
        e.forEach(function (e) {
          Object.defineProperty(n.events, e, { value: new Lr(e) });
        }),
          r &&
            e.forEach(function (e) {
              var t = r[e];
  ...
  function Nr(e, t) {
    for (var r = [], n = 0; n < e.length; n++) {
      var a = e[n],
        o = t.current,
        s = Fr((o = Array.isArray(o) ? o[0] : o), a);
      -1 !== s && r.push(s);
    }
    return r.length !== e.length ? -1 : r;
  }
  (Pt.prototype.exec = function (e, t) {
    ...
    (Bt = [
      ...
      function (e) {
        O.DEBUG && console.log(e.step, "RTHG[]"), (e.round = _t);
      },
      function (e) {
        var t = e.stack.pop();
      ...
      void 0,
      function (e) {
        O.DEBUG && console.log(e.step, "RUTG[]"), (e.round = qt);
      },
      function (e) {
      ...
      Ur.bind(void 0, 7),
      Ur.bind(void 0, 8),
      kr.bind(void 0, 0, 0, 0, 0, 0),
      kr.bind(void 0, 0, 0, 0, 0, 1),
      kr.bind(void 0, 0, 0, 0, 0, 2),
      kr.bind(void 0, 0, 0, 0, 0, 3),
      kr.bind(void 0, 0, 0, 0, 1, 0),
      kr.bind(void 0, 0, 0, 0, 1, 1),
      kr.bind(void 0, 0, 0, 0, 1, 2),
      kr.bind(void 0, 0, 0, 0, 1, 3),
      kr.bind(void 0, 0, 0, 1, 0, 0),
      kr.bind(void 0, 0, 0, 1, 0, 1),
      kr.bind(void 0, 0, 0, 1, 0, 2),
      kr.bind(void 0, 0, 0, 1, 0, 3),
      kr.bind(void 0, 0, 0, 1, 1, 0),
      kr.bind(void 0, 0, 0, 1, 1, 1),
      kr.bind(void 0, 0, 0, 1, 1, 2),
      kr.bind(void 0, 0, 0, 1, 1, 3),
      kr.bind(void 0, 0, 1, 0, 0, 0),
      kr.bind(void 0, 0, 1, 0, 0, 1),
      kr.bind(void 0, 0, 1, 0, 0, 2),
      kr.bind(void 0, 0, 1, 0, 0, 3),
      kr.bind(void 0, 0, 1, 0, 1, 0),
      kr.bind(void 0, 0, 1, 0, 1, 1),
      kr.bind(void 0, 0, 1, 0, 1, 2),
      kr.bind(void 0, 0, 1, 0, 1, 3),
      kr.bind(void 0, 0, 1, 1, 0, 0),
      kr.bind(void 0, 0, 1, 1, 0, 1),
      kr.bind(void 0, 0, 1, 1, 0, 2),
      kr.bind(void 0, 0, 1, 1, 0, 3),
      kr.bind(void 0, 0, 1, 1, 1, 0),
      kr.bind(void 0, 0, 1, 1, 1, 1),
      kr.bind(void 0, 0, 1, 1, 1, 2),
      kr.bind(void 0, 0, 1, 1, 1, 3),
      kr.bind(void 0, 1, 0, 0, 0, 0),
      kr.bind(void 0, 1, 0, 0, 0, 1),
      kr.bind(void 0, 1, 0, 0, 0, 2),
      kr.bind(void 0, 1, 0, 0, 0, 3),
      kr.bind(void 0, 1, 0, 0, 1, 0),
      kr.bind(void 0, 1, 0, 0, 1, 1),
      kr.bind(void 0, 1, 0, 0, 1, 2),
      kr.bind(void 0, 1, 0, 0, 1, 3),
      kr.bind(void 0, 1, 0, 1, 0, 0),
      kr.bind(void 0, 1, 0, 1, 0, 1),
      kr.bind(void 0, 1, 0, 1, 0, 2),
      kr.bind(void 0, 1, 0, 1, 0, 3),
      kr.bind(void 0, 1, 0, 1, 1, 0),
      kr.bind(void 0, 1, 0, 1, 1, 1),
      kr.bind(void 0, 1, 0, 1, 1, 2),
      kr.bind(void 0, 1, 0, 1, 1, 3),
      kr.bind(void 0, 1, 1, 0, 0, 0),
      kr.bind(void 0, 1, 1, 0, 0, 1),
      kr.bind(void 0, 1, 1, 0, 0, 2),
      kr.bind(void 0, 1, 1, 0, 0, 3),
      kr.bind(void 0, 1, 1, 0, 1, 0),
      kr.bind(void 0, 1, 1, 0, 1, 1),
      kr.bind(void 0, 1, 1, 0, 1, 2),
      kr.bind(void 0, 1, 1, 0, 1, 3),
      kr.bind(void 0, 1, 1, 1, 0, 0),
      kr.bind(void 0, 1, 1, 1, 0, 1),
      kr.bind(void 0, 1, 1, 1, 0, 2),
      kr.bind(void 0, 1, 1, 1, 0, 3),
      kr.bind(void 0, 1, 1, 1, 1, 0),
      kr.bind(void 0, 1, 1, 1, 1, 1),
      kr.bind(void 0, 1, 1, 1, 1, 2),
      kr.bind(void 0, 1, 1, 1, 1, 3),
    ]),
    ...
    (Cr.prototype.inboundIndex = function (e) {
      return 0 <= e && e < this.tokens.length;
    }),
    (Cr.prototype.composeRUD = function (e) {
      function t(e) {
    ...
    (Cr.prototype.replaceRange = function (e, t, r, n) {
    ...
    (Cr.prototype.replaceToken = function (e, t, r) {
    ...
    (Cr.prototype.registerModifier = function (o, s, i) {
    ...
    (Lr.prototype.subscribe = function (e) {
      return "function" == typeof e
        ? this.subscribers.push(e) - 1
        : { FAIL: "invalid '" + this.eventId + "' event handler" };
    }),
    (Lr.prototype.unsubscribe = function (e) {
    ...
    (Cr.prototype.rangeToText = function (e) {
      if (e instanceof Er)
    ...
    (Cr.prototype.getContext = function (e) {
      var t = this.registeredContexts[e];
      return t || null;
    }),
    (Cr.prototype.on = function (e, t) {
      var r = this.events[e];
      return r ? r.subscribe(t) : null;
    }),
    (Cr.prototype.dispatch = function (e, t) {
      var r = this,
        n = this.events[e];
      n instanceof Lr &&
    ...
    (Cr.prototype.registerContextChecker = function (e, t, r) {
    ...
    (Cr.prototype.setEndOffset = function (e, t) {
    ...
    (Cr.prototype.runContextCheck = function (o) {
      var s = this,
        i = o.index;
    ...
    (Cr.prototype.tokenize = function (e) {
    ...
    (Gr.prototype.getDefaultScriptFeaturesIndexes = function () {
    ...
    (Gr.prototype.getScriptFeaturesIndexes = function (e) {
    ...
    (Gr.prototype.mapTagsToFeatures = function (e, t) {
      for (var r = {}, n = 0; n < e.length; n++) {
        var a = e[n].tag,
          o = e[n].feature;
        r[a] = o;
    ...
    (Gr.prototype.getScriptFeatures = function (e) {
    ...
    (Gr.prototype.getSubstitutionType = function (e, t) {
      return e.lookupType.toString() + t.substFormat.toString();
    }),
    (Gr.prototype.getLookupMethod = function (e, t) {
      var r = this;
      switch (this.getSubstitutionType(e, t)) {
        case "11":
          return function (e) {
            return function (e, t) {
              return -1 === Fr(e, t.coverage) ? null : e + t.deltaGlyphId;
            }.apply(r, [e, t]);
          };
        case "12":
          return function (e) {
            return function (e, t) {
              var r = Fr(e, t.coverage);
    ...
    (Gr.prototype.lookupFeature = function (e) {
      ...
      for (
        ...
        for (
          ...
          switch (c) {
            case "11":
              (f = h(t.current)) &&
                o.splice(r, 1, new Ar({ id: 11, tag: e.tag, substitution: f }));
              break;
            case "12":
              (f = h(t.current)) &&
                o.splice(r, 1, new Ar({ id: 12, tag: e.tag, substitution: f }));
              break;
            case "63":
              (f = h(t)),
                Array.isArray(f) &&
                  ...
                  o.splice(
                    r,
                    1,
                    new Ar({ id: 63, tag: e.tag, substitution: f })
                  );
              break;
            case "41":
              (f = h(t)) &&
                o.splice(r, 1, new Ar({ id: 41, tag: e.tag, substitution: f }));
              break;
            case "21":
              (f = h(t.current)) &&
                o.splice(r, 1, new Ar({ id: 21, tag: e.tag, substitution: f }));
          }
          (t = new wr(o, r)), (Array.isArray(f) && !f.length) || (f = null);
        }
      return o.length ? o : null;
    }),
    (Gr.prototype.supports = function (t) {
    ...
    (Gr.prototype.getLookupSubtables = function (e) {
      return e.subtables || null;
    }),
    (Gr.prototype.getLookupByIndex = function (e) {
      return this.font.tables.gsub.lookups[e] || null;
    }),
    (Gr.prototype.getFeatureLookups = function (e) {
      return e.lookupListIndexes.map(this.getLookupByIndex.bind(this));
    }),
    (Gr.prototype.getFeature = function (e) {
  ...
  function Wr(e, t, r) {
    e instanceof Ar && zr[e.id] && zr[e.id](e, t, r);
  }
  function _r(e) {
    var o = this,
        ...
        if (!Mr(e.char)) {
          ...
          if (-1 !== s.indexOf(r)) {
            ...
            a.forEach(function (e, t) {
              e instanceof Ar && (Wr(e, i, t), (u.context[t] = e.substitution));
            });
          }
        }
      });
  ...
  function Jr(e) {
    ((e = e || {}).tables = e.tables || {}),
      ...
      (this.position = new Ut(this)),
      (this.substitution = new kt(this)),
  ...
  (jr.prototype.setText = function (e) {
    this.text = e;
  }),
    (jr.prototype.contextChecks = {
      latinWordCheck: Xr,
      arabicWordCheck: Pr,
      arabicSentenceCheck: Hr,
    }),
    (jr.prototype.registerFeatures = function (t, e) {
      var r = this,
    ...
    (jr.prototype.applyFeatures = function (e, t) {
      if (!e) throw new Error("No valid font was provided to apply features");
      this.query || (this.query = new Gr(e));
      for (var r = 0; r < t.length; r++) {
        var n = t[r];
    ...
    (jr.prototype.registerModifier = function (e, t, r) {
      this.tokenizer.registerModifier(e, t, r);
    }),
    (jr.prototype.checkContextReady = function (e) {
      return !!this.tokenizer.getContext(e);
    }),
    (jr.prototype.applyFeaturesToContexts = function () {
    ...
    (jr.prototype.processText = function (e) {
      (this.text && this.text === e) ||
        (this.setText(e),
        function () {
          return (
            Yr.call(this, "latinWord"),
            Yr.call(this, "arabicWord"),
            Yr.call(this, "arabicSentence"),
            this.tokenizer.tokenize(this.text)
          );
        }.call(this),
        this.applyFeaturesToContexts());
    }),
    (jr.prototype.getBidiText = function (e) {
      return this.processText(e), this.tokenizer.getText();
    }),
    (jr.prototype.getTextGlyphs = function (e) {
      this.processText(e);
  ...
  var on = {
    parse: function (e, t) {
      var r = new oe(e, (t = t || 0)),
        n = r.parseVersion(1);
      return (
        C.argument(1 === n || 1.1 === n, "Unsupported GPOS table version " + n),
        1 === n
          ? {
              version: n,
              scripts: r.parseScriptList(),
    ...
    make: function (e) {
      return new $.Table("GPOS", [
        ...
        },
        {
          name: "lookups",
          type: "TABLE",
          value: new $.LookupList(e.lookups, an),
        },
      ]);
    },
  };
    ...
    parse: function (e, t) {
      ...
      if (0 === n)
        return (function (e) {
          ...
          e.skip("uShort");
          var r = e.parseUShort();
          C.argument(0 === r, "Unsupported kern sub-table version."),
            e.skip("uShort", 2);
          var n = e.parseUShort();
          e.skip("uShort", 3);
          for (var a = 0; a < n; a += 1) {
  ...
  function fn(e, t) {
    ...
    var a,
      ...
      y = [],
      b = ie.getTag(m, 0);
    if (b === String.fromCharCode(0, 1, 0, 0) || "true" === b || "typ1" === b)
      (v.outlinesFormat = "truetype"), (y = cn(m, (a = ie.getUShort(m, 4))));
    else if ("OTTO" === b)
      (v.outlinesFormat = "cff"), (y = cn(m, (a = ie.getUShort(m, 4))));
    else {
      if ("wOFF" !== b) throw new Error("Unsupported OpenType signature " + b);
      var S = ie.getTag(m, 4);
      if (S === String.fromCharCode(0, 1, 0, 0)) v.outlinesFormat = "truetype";
      else {
        if ("OTTO" !== S) throw new Error("Unsupported OpenType flavor " + b);
    ...
    for (var x = 0; x < a; x += 1) {
      ...
      switch (T.tag) {
        case "cmap":
          (U = hn(m, T)),
            (v.tables.cmap = ue.parse(U.data, U.offset)),
            (v.encoding = new de(v.tables.cmap));
          break;
        case "cvt ":
          (U = hn(m, T)),
            (g = new ie.Parser(U.data, U.offset)),
        ...
        case "head":
          (U = hn(m, T)),
            (v.tables.head = ze.parse(U.data, U.offset)),
            (v.unitsPerEm = v.tables.head.unitsPerEm),
            (r = v.tables.head.indexToLocFormat);
          break;
        case "hhea":
          (U = hn(m, T)),
            (v.tables.hhea = We.parse(U.data, U.offset)),
        ...
        case "hmtx":
          ...
          break;
        case "ltag":
          (U = hn(m, T)), (n = qe.parse(U.data, U.offset));
          break;
        case "maxp":
          (U = hn(m, T)),
            (v.tables.maxp = Xe.parse(U.data, U.offset)),
        ...
        case "name":
          ...
          break;
        case "OS/2":
          (U = hn(m, T)), (v.tables.os2 = st.parse(U.data, U.offset));
          break;
        case "post":
          (U = hn(m, T)),
            (v.tables.post = it.parse(U.data, U.offset)),
            (v.glyphNames = new ve(v.tables.post));
          break;
        case "prep":
          (U = hn(m, T)),
            (g = new ie.Parser(U.data, U.offset)),
    ...
    var k = hn(m, f);
    if (
      ((v.tables.name = at.parse(k.data, k.offset, n)),
      (v.names = v.tables.name),
      i && h)
    ) {
      var O = 0 === r,
        E = hn(m, h),
        R = un.parse(E.data, E.offset, v.numGlyphs, O),
        w = hn(m, i);
      v.glyphs = Nt.parse(w.data, w.offset, R, v, t);
    } else {
      if (!o) throw new Error("Font doesn't contain TrueType or CFF outlines.");
      var L = hn(m, o);
      He.parse(L.data, L.offset, v, t);
    }
    var C = hn(m, p);
    if (
      (_e.parse(
      ...
      var D = hn(m, c);
      v.kerningPairs = sn.parse(D.data, D.offset);
    } else v.kerningPairs = {};
    if (u) {
      var I = hn(m, u);
      (v.tables.gpos = on.parse(I.data, I.offset)), v.position.init();
    }
    if (l) {
      var M = hn(m, l);
      v.tables.gsub = ct.parse(M.data, M.offset);
    }
    if (s) {
      var B = hn(m, s);
      v.tables.fvar = rn.parse(B.data, B.offset, v.names);
    }
    if (d) {
      var G = hn(m, d);
      (v.tables.meta = ht.parse(G.data, G.offset)), (v.metas = v.tables.meta);
    }
    return v;
  }
  function dn(e, o, s) {
    var t = "undefined" == typeof window ? ln : pn;
  ...
  function gn(e, t) {
    return fn(Rt(require("fs").readFileSync(e)), t);
  }
      ...
      1: [
        function (e, n, t) {
              ...
              (y &&
                (a = (function (e, n, t, r) {
                  ...
                  for (x = 0, i = n.length; x < i; x++)
                    (u = n[x] * r),
                      (f = x < i - 1 ? n[x + 1] * r : e.length),
                      (f = c(e, u, f, r, !1)) === f.next && (f.steiner = !0),
                      o.push(
                        (function (e) {
                          var n = e,
                            t = e;
                  ...
                  for (o.sort(Z), x = 0; x < o.length; x++)
                    !(function (e, n) {
                      (n = (function (e, n) {
                        ...
                        return t;
                      })(e, n)) && ((e = m(n, e)), s(n, n.next), s(e, e.next));
                    })(o[x], t),
                      (t = s(t, t.next));
                  return t;
                })(e, n, a, t)),
          ...
          function c(e, n, t, r, x) {
            var i, u;
            if (x === 0 < z(e, n, t, r))
              for (i = n; i < t; i += r) u = f(i, e[i], e[i + 1], u);
            else for (i = t - r; n <= i; i -= r) u = f(i, e[i], e[i + 1], u);
            return u && y(u, u.next) && (a(u), (u = u.next)), u;
          }
          function s(e, n) {
            if (!e) return e;
            n = n || e;
            ...
            do {
              if (
                ...
                if ((a(r), (r = n = r.prev) === r.next)) break;
                t = !0;
              }
            } while (t || r !== n);
            return n;
                ...
                if (
                  ...
                  i
                    ? (function (e, n, t, r) {
                        ...
                        var f = (
                            x.x < i.x ? (x.x < u.x ? x : u) : i.x < u.x ? i : u
                          ).x,
                          o = (
                            x.y < i.y ? (x.y < u.y ? x : u) : i.y < u.y ? i : u
                          ).y,
                          v = (
                            x.x > i.x ? (x.x > u.x ? x : u) : i.x > u.x ? i : u
                          ).x,
                        ...
                        for (; l && l.z >= p && h && h.z <= a; ) {
                          if (
                            l !== e.prev &&
                            l !== e.next &&
                            w(x.x, x.y, i.x, i.y, u.x, u.y, l.x, l.y) &&
                            0 <= M(l.prev, l, l.next)
                          )
                            return !1;
                          if (
                            ...
                            h !== e.prev &&
                              h !== e.next &&
                              w(x.x, x.y, i.x, i.y, u.x, u.y, h.x, h.y) &&
                              0 <= M(h.prev, h, h.next))
                          )
                            return !1;
                          h = h.nextZ;
                    ...
                    : (function (e) {
                        ...
                        for (; x !== e.prev; ) {
                          if (
                            w(n.x, n.y, t.x, t.y, r.x, r.y, x.x, x.y) &&
                            0 <= M(x.prev, x, x.next)
                          )
                            return !1;
                          x = x.next;
          ...
          function b(e, n) {
            return M(e.prev, e, e.next) < 0
              ? 0 <= M(e, n, e.next) && 0 <= M(e, e.prev, n)
              : M(e, n, e.prev) < 0 || M(e, e.next, n) < 0;
          }
          function m(e, n) {
          ...
          (n.exports = r),
            ((n.exports.default = r).deviation = function (e, n, t, r) {
              var x = n && n.length,
                i = x ? n[0] * t : e.length,
                u = Math.abs(z(e, 0, i, t));
              if (x)
...
PlayerCamera.attributes.add("fovv", { type: "number", default: 80 }),
  (PlayerCamera.prototype.initialize = function () {
    this.entity.camera
      ...
      : console.error(
          "This script must be applied to an entity with a camera component."
        );
  }),
  (PlayerCamera.prototype.mouseDown = function (t) {
    this.doRaycast(t.x, t.y);
  }),
  (PlayerCamera.prototype.touchStart = function (t) {
    1 === t.touches.length && this.doRaycast(t.touches[0].x, t.touches[0].y),
      t.event.preventDefault();
  }),
  (PlayerCamera.prototype.doRaycast = function (t, a) {
    var e = this.entity.getPosition(),
      o = this.entity.camera.screenToWorld(t, a, this.entity.camera.farClip),
      r = this.app.systems.rigidbody.raycastFirst(e, o);
    if (r) {
      var s = r.entity;
      console.log("You selected " + s.name),
        !0 === s.tags.has("destructable") && s.destroy();
    }
  }),
  (PlayerCamera.prototype.update = function (t) {
    this.app.mouse.isPressed(pc.MOUSEBUTTON_RIGHT) &&
      (this.cameraEntity.camera.fov = 30),
      this.app.mouse.wasReleased(pc.MOUSEBUTTON_RIGHT) &&
        (this.cameraEntity.camera.fov = this.fovv);
  });
var Terrain = pc.createScript("terrain");
Terrain.attributes.add("heightMap", { type: "asset", assetType: "texture" }),
  Terrain.attributes.add("minHeight", { type: "number", default: 0 }),
  Terrain.attributes.add("maxHeight", { type: "number", default: 10 }),
  Terrain.attributes.add("width", { type: "number", default: 100 }),
  Terrain.attributes.add("depth", { type: "number", default: 100 }),
  Terrain.attributes.add("subdivisions", { type: "number", default: 250 }),
  Terrain.attributes.add("material", { type: "asset", assetType: "material" }),
  (Terrain.prototype.initialize = function () {
    var i = this.heightMap.resource.getSource(),
      e = this.createTerrainFromHeightMap(i, this.subdivisions),
      t = this.createTerrainFromHeightMap(i, this.subdivisions / 2);
    this.entity.addComponent("render", {
      meshInstances: [new pc.MeshInstance(e, this.material.resource)],
    }),
      this.entity.addComponent("collision", { type: "mesh" });
    var s = new pc.GraphNode(),
      r = new pc.MeshInstance(s, t, this.material.resource),
      a = new pc.Model();
    (a.graph = s),
      a.meshInstances.push(r),
      (this.entity.collision.model = a),
      this.entity.addComponent("rigidbody", { friction: 0.5, type: "static" });
  }),
  (Terrain.prototype.createTerrainVertexData = function (i) {
    var e,
      t,
      s = [],
      r = [],
      a = [];
    for (e = 0; e <= i.subdivisions; e++)
      for (t = 0; t <= i.subdivisions; t++) {
        var n = new pc.Vec3(
            (t * i.width) / i.subdivisions - i.width / 2,
            0,
            ((i.subdivisions - e) * i.height) / i.subdivisions - i.height / 2
          ),
          h =
            4 *
            (((((n.x + i.width / 2) / i.width) * (i.bufferWidth - 1)) | 0) +
              (((1 - (n.z + i.height / 2) / i.height) * (i.bufferHeight - 1)) |
                0) *
                i.bufferWidth),
          d =
            0.3 * (i.buffer[h] / 255) +
            0.59 * (i.buffer[h + 1] / 255) +
            0.11 * (i.buffer[h + 2] / 255);
        (n.y = i.minHeight + (i.maxHeight - i.minHeight) * d),
          s.push(n.x, n.y, n.z),
          r.push(t / i.subdivisions, 1 - e / i.subdivisions);
      }
    for (e = 0; e < i.subdivisions; e++)
      for (t = 0; t < i.subdivisions; t++)
        a.push(t + e * (i.subdivisions + 1)),
          a.push(t + 1 + e * (i.subdivisions + 1)),
          a.push(t + 1 + (e + 1) * (i.subdivisions + 1)),
          a.push(t + e * (i.subdivisions + 1)),
          a.push(t + 1 + (e + 1) * (i.subdivisions + 1)),
          a.push(t + (e + 1) * (i.subdivisions + 1));
    return {
      indices: a,
      positions: s,
      normals: pc.calculateNormals(s, a),
      uvs: r,
    };
  }),
  (Terrain.prototype.createTerrainFromHeightMap = function (i, e) {
    var t = document.createElement("canvas"),
      s = t.getContext("2d"),
      r = i.width,
      a = i.height;
    (t.width = r), (t.height = a), s.drawImage(i, 0, 0);
    var n = s.getImageData(0, 0, r, a).data,
      h = this.createTerrainVertexData({
        width: this.width,
        height: this.depth,
        subdivisions: e,
      ...
      d = new pc.Mesh(this.app.graphicsDevice);
    return (
      d.setPositions(h.positions),
      d.setNormals(h.normals),
      d.setUvs(0, h.uvs),
      d.setIndices(h.indices),
      d.update(),
      d
    );
  });
...
(CameraManager.prototype.initialize = function () {
  ...
  (CameraManager.prototype.onKeyDown = function (a) {
    a.event.preventDefault();
  }),
  (CameraManager.prototype.setCamera = function (a) {
    (this.activeCamera.enabled = !1),
      (this.activeCamera = this.entity.findByName(a)),
      (this.activeCamera.enabled = !0);
  }),
  (CameraManager.prototype.update = function (a) {
    var e = this.app;
    e.keyboard.wasPressed(pc.KEY_RIGHT)
      ? this.setCamera("Camera")
      : e.keyboard.wasPressed(pc.KEY_LEFT) && this.setCamera("Camera2");
  });
